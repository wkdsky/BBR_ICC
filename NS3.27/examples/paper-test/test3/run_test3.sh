...
printf '%s\n' \
  'scenario_id,capacity_bps,capacity_mbps,initial_queue_bdp,bottleneck_delay_s,access_bps,simulation_time_s,sample_interval_s,settle_guard_s,propagation_rtt_profile,purpose,algorithm,mode,seed,run_id,run_summary_path,rtt_profile_path,rtt_timeseries_path,probe_phase_trace_path,metadata_path' \
  > "${MANIFEST_REL}"
...
run_case() {
  ...
  for suffix in run_summary rtt_profile rtt_timeseries probe_phase_trace; do
  ...
  printf '%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n' \
    ...
    "${prefix}_rtt_timeseries.csv" "${prefix}_probe_phase_trace.csv" \
