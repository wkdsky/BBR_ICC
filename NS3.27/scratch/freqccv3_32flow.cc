 ...
 * n31---L31-------|                    |------L64------n65
 *
 * 32 FreqCCv3 flows, 64Mbps bottleneck, 60ms RTT, buffer = 2xBDP
 */
...
#define DQC_SCENARIO_LOG_COMPONENT "freqccv3-32flow"
#endif
#ifndef DQC_SCENARIO_INSTANCE
#define DQC_SCENARIO_INSTANCE "freqccv3_32flow"
#endif
#ifndef DQC_SCENARIO_TITLE
#define DQC_SCENARIO_TITLE "32 FreqCCv3 Flows"
#endif
